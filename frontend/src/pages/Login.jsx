...
import { Mail, Lock, Loader2, Eye, EyeOff, BookOpen, MailCheck, ArrowRight } from "lucide-react";
...
const Login = () => {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const res = await API.post(endpoints.auth.verifyOtp, { email: unverifiedEmail, otp });
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-lg max-w-md w-full p-8 space-y-6">
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              We've sent a 6-digit code to <span className="font-bold text-gray-800">{unverifiedEmail}</span>
            </p>
          </div>
      ...
      <div className="bg-white w-full max-w-4xl rounded-2xl shadow-xl border border-gray-100 overflow-hidden flex">
          ...
          <div className="relative z-10 flex flex-col justify-between h-full p-10">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm">
                Thousands of books, one destination.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 p-8 lg:p-12 flex flex-col justify-center space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Sign in to your BookNest account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between">
                ...
                <Link to="/forgot-password" className="text-xs font-semibold text-[#1a3a2a] hover:underline">Forgot?</Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link to="/register" className="font-bold text-[#1a3a2a] hover:underline">Create one →</Link>
          </p>
        </div>
      </div>
    </div>
